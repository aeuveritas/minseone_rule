...
1. 마지막 회의 이후 `3주 이내에, 한달에 최소 2번` 이상의 회의를 소집해야 한다.
...
1. 민서네 위원들의 자치 활동을 지원하기 위하여 상시 활동하는 위원회들이다.
2. 각 상설 위원회의 세부 사항은 `민주 서울 네트워크 위원회` 문서에 따로 명시한다.
...
1. 민서네 위원들의 자치 활동을 지원하나 반복적인 사건 또는 시기에만 필요한 위원회이다.
2. 각 준상설 위원회의 세부 사항은 `민주 서울 네트워크 위원회` 문서에 따로 명시한다.

#### 구성

1. 준상설 위원회의 구성은 `민주 서울 네트워크 위원회` 문서를 따른다.

#### 역할

1. 준상설 위원회의 역할은 `민주 서울 네트워크 위원회` 문서를 따른다.

#### 운영

1. 준상설 위원회의 운영은 `민주 서울 네트워크 위원회` 문서를 따른다.
...
3. 위원장 요청 시 최종 또는 중간 결과를 정리하여 운영 위원회에 제출한다.
...
1. 민서네 전체 위원들의 `30% 이상이 투표에 참여하고, 투표 참여 인원의 과반수 이상 찬성`으로 승인된다.
...
1. 탄핵안 제안은 민서네의 공식 온라인 플랫폼[^4]을 통해 누구나 할 수 있으나 민서네 전체 위원들의 `20% 이상이 동의`하면 자동 발의된다.
...
1. 위원장이 스스로 직무를 수행할 수 없다고 판단할 경우, 부위원장에게 권한을 위임하고 사임하여 위원장직을 공석으로 만들 수 있다.
