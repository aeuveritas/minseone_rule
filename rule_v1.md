...
2. 투표 참여율이 전체 구성원의 30% 미만인 경우, 해당 투표는 무효로 처리된다.
...
3. `정보관리 부실`: 민서네 전체 위원들의 개인정보를 부주의하게 관리하여 유출 사고를 초래한 경우
