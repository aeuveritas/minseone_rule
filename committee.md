...
5. 기획서 작성에 필요한 템플릿과 구체적인 작성 예시를 제공합니다.

#### 실행 단계 지원

1. 실행 단계에서 필요한 실무적 지원을 제공합니다.
2. 장소 섭외, 필요한 장비 대여, 예산 집행 등 실행에 필요한 구체적인 지원을 제공합니다.
3. 서울시당 및 중앙당과의 협업이 필요한 경우, 카운터파트로서 업무를 진행합니다.
4. 진행 상황을 주기적으로 모니터링하고, 필요한 경우 추가적인 지원을 제공합니다.

#### 실행 완료 후

1. 담당 운영 위원은 활동이 종료된 이후 이주일 이내에 활동 완료 보고서를 작성하여 활동 지원 위원회에 제출해야 한다.
2. 활동 완료 보고서에는 주요 일정 및 참여자, 경비 사용 내용등을 기록해야 한다.
...
5. 지원 완료 보고서에는 지원 내용 및 시행 착오, 개선 사항등을 정리하여 작성한다.
